...
- Асинхронный вариант, задача выполняется в отдельной горутине, task ID и статистика хранятся в Redis (с использованием Redis pool)
...
- Хранение ID задачи и статистики в Redis - `redigo`
